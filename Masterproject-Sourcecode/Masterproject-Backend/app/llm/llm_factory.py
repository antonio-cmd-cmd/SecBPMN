...
def create_generator_llm():
    ...
    if GENERATOR_LLM_PROVIDER == "gemini":
        ...
        print(f"Creating Generator LLM: Ollama model {GENERATOR_OLLAMA_MODEL} at {GENERATOR_OLLAMA_BASE_URL}")
        return ChatOllama(
...
def create_validator_llm():
    ...
    if VALIDATOR_LLM_PROVIDER == "gemini":
        ...
        print(f"Creating Validator LLM: Ollama model {VALIDATOR_OLLAMA_MODEL} at {VALIDATOR_OLLAMA_BASE_URL}")
        return ChatOllama(
