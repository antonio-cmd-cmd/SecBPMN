        ...
        threats: [
            {
                ...
                description: "uption, the fraudulent modification of data can be understood. It happens when information is manipulated within either an application or also a system. Incidents in the past have shown that tampering with cookies is a widely used technique to corrupt data in an unauthorized manner."
            },
            {
                threat: "Malicious Code Modification",
                description: "de programming small modifications can have a huge impact. Logic bombs, trojan horses, and other malicious code injections are examples of this attack group."
            },
            {
