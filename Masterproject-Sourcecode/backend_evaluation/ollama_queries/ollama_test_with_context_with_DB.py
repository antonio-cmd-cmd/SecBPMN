...
with open("resources/knowledgeBaseLLM.js", "r", encoding="utf-8") as file:
...
print("Now, let's analyze the BPMN XML using the knowledge base.")

second_prompt = f"""
# BPMN Process Threat Analyzer
You are an expert in business process analysis and threat modeling. You are specially trained on insider threats. Analyze the BPMN XML file for potential insider threats or vulnerabilities.
## IMPORTANT RULES:
- DO NOT describe XML structure or technical elements
- DO NOT mention IDs, coordinates, or diagram specifics
- ONLY focus on named elements that describe the business process flow

Consider the insider threat knowledge base for your interpretation of the business process:
{knowledge_base}
...
STEP 1: Identify potential insider threats or vulnerabilities in the process flow.
STEP 2: Describe at which BPMN element the threat could occur in the business process.
...
print(f"\n\n2nd Response from Ollama {model}:")
